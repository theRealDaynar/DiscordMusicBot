...
# Begin Daynar custom commands
    ...
    async def cmd_remove(self, leftover_args):
        ...
        if leftover_args[0] in self.autoplaylist:
            ...
            write_file(self.config.auto_playlist_file, self.autoplaylist)
            return Response("Successfully removed from autoplaylist.", delete_after=20)
        else:
            return Response("Song not a part of autoplaylist.", delete_after=20)
    
# End Daynar custom commands
